                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.MultipleApiVersions(
                            ...
                            (info) =>
                            {
                                foreach (var group in apiExplorer.ApiDescriptions)
                                {
                                    ...
                                    {
                                        description += " Esta versão da API está obsoleta.";
                                    }
                        ...
                        c.OAuth2("oauth2")
                            ...
                            .Scopes(scopes =>
                            {
                                scopes.Add("Administrator", "Usuário configurado no NDS com permissão para utilizar o serviço de automação.");
                            });
    ...
    public class AddRequiredHeaderParameter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            operation.parameters.Add(new Parameter
            {
                ...
                type = "string",
                required = true,
                description = @"Idioma considerado no retorno. Use ""pt-br"" para português e ""en-us"" para inglês.",
                @default = "pt-br"
            });
        }
    }
