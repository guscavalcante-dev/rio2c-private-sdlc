...
GO
INSERT [dbo].[LogisticSponsors] ([Id], [Uid], [Name], [IsAirfareTicketRequired], [IsOtherRequired], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (1, N'56d74d6b-31d5-4652-8685-213216fb22a8', N'Rio2C', 1, 0, 0, CAST(N'2020-01-23 15:02:16.733' AS DateTime), 1, CAST(N'2020-01-23 15:02:16.733' AS DateTime), 1)
GO
INSERT [dbo].[LogisticSponsors] ([Id], [Uid], [Name], [IsAirfareTicketRequired], [IsOtherRequired], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (2, N'b75920d0-05e0-4b72-bed1-1ab3cfe8ed2b', N'APEX', 1, 0, 0, CAST(N'2020-01-23 15:02:16.740' AS DateTime), 1, CAST(N'2020-01-23 15:02:16.740' AS DateTime), 1)
GO
INSERT [dbo].[LogisticSponsors] ([Id], [Uid], [Name], [IsAirfareTicketRequired], [IsOtherRequired], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (3, N'421c6c70-ef6e-4071-b00f-7c4c222aa410', N'Próprio | Own', 0, 0, 0, CAST(N'2020-01-23 15:02:16.750' AS DateTime), 1, CAST(N'2020-01-23 15:02:16.750' AS DateTime), 1)
GO
INSERT [dbo].[LogisticSponsors] ([Id], [Uid], [Name], [IsAirfareTicketRequired], [IsOtherRequired], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (4, N'37030831-5d54-4227-a050-820a32a0ad95', N'Patrocinado por outras instituições | Sponsored by other institutions', 0, 1, 0, CAST(N'2020-01-23 15:02:16.753' AS DateTime), 1, CAST(N'2020-01-23 15:02:16.753' AS DateTime), 1)
GO
...
GO
INSERT [dbo].[LogisticTransferStatuses] ([Id], [Uid], [Name], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (1, N'2a6b8ecc-7e85-4f35-9e50-84570c9f5431', N'Confirmado | Confirmed', 0, CAST(N'2020-01-27 14:22:18.680' AS DateTime), 1, CAST(N'2020-01-27 14:22:18.680' AS DateTime), 1)
GO
INSERT [dbo].[LogisticTransferStatuses] ([Id], [Uid], [Name], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (2, N'bd4d79df-d193-4b40-a144-71d95b2fc169', N'Dispensado | Waived', 0, CAST(N'2020-01-27 14:22:18.683' AS DateTime), 1, CAST(N'2020-01-27 14:22:18.683' AS DateTime), 1)
GO
INSERT [dbo].[LogisticTransferStatuses] ([Id], [Uid], [Name], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (3, N'926db045-af08-4132-8781-bbffc0e9bea9', N'Código Uber | Uber Code', 0, CAST(N'2020-01-27 14:22:18.703' AS DateTime), 1, CAST(N'2020-01-27 14:22:18.703' AS DateTime), 1)
GO
INSERT [dbo].[LogisticTransferStatuses] ([Id], [Uid], [Name], [IsDeleted], [CreateDate], [CreateUserId], [UpdateDate], [UpdateUserId]) VALUES (4, N'0ba5ad37-0863-4eb0-8fc2-85b3c025c269', N'Fora do período de serviço | Outside the service period', 0, CAST(N'2020-01-27 14:22:18.727' AS DateTime), 1, CAST(N'2020-01-27 14:22:18.727' AS DateTime), 1)
GO
