...
{
    /// <summary>LogisticTransferMap</summary>
    public class LogisticTransferMap : EntityTypeConfiguration<LogisticTransfer>
    {
        /// <summary>Initializes a new instance of the <see cref="LogisticTransferMap"/> class.</summary>
        public LogisticTransferMap()
        {
            this.ToTable("LogisticTransfers");

            this.Property(p => p.AdditionalInfo)
                .HasMaxLength(LogisticTransfer.AdditionalInfoMaxLength);
