...
namespace PlataformaRio2C.Infra.Data.Repository.Repositories
{
    ...
    internal static class AttendeeeCollaboratorIQueryableExtensions
    {
        ...
        /// <param name="query">The query.</param>
        /// <returns></returns>
        internal static IQueryable<AttendeeCollaborator> HasActiveSellerNegotiations(this IQueryable<AttendeeCollaborator> query)
        {
            query = query.Where(ao => ao.MusicBusinessRoundProjects.Any(sp => !sp.IsDeleted
                                                                         && sp.MusicBusinessRoundProjectBuyerEvaluations.Any(pbe => pbe.ProjectEvaluationStatusId == ProjectEvaluationStatus.Accepted.Id
                                                                                                           && !pbe.IsDeleted
        ...
        /// <returns></returns>
        internal static IQueryable<AttendeeCollaborator> FindByOrganizationTypeUidAndEditionId(this IQueryable<AttendeeCollaborator> query, int editionId, bool showAllEditions, Guid organizationTypeUid)
        {
            query = query.Where(ao => (showAllEditions || ao.EditionId == editionId)
                                      && ao.AttendeeCollaboratorTypes.Any(aot => aot.CollaboratorType.Uid == organizationTypeUid
                                                                                  && !aot.IsDeleted
                                                                                  && !aot.CollaboratorType.IsDeleted));
    ...
    /// </summary>
    internal static class MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDtoIQueryableExtensions
    {
        /// <summary>
        /// To the list paged.
        /// </summary>
        ...
        /// <returns></returns>
        internal static async Task<IPagedList<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto>> ToListPagedAsync(this IQueryable<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto> query, int page, int pageSize)
        {
            page++;
    ...
    public class AttendeeCollaboratorRepository : Repository<PlataformaRio2CContext, AttendeeCollaborator>, IAttendeeCollaboratorRepository
    {
        ...
        /// <returns></returns>
        public async Task<IPagedList<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto>> FindAllByActiveBuyerNegotiationsAndByDataTable(
            int page,
            int pageSize,
            string keywords,
            List<Tuple<string, string>> sortColumns,
            ...
            int languageId)
        {
            ...
            return await query
                         .DynamicOrder<AttendeeCollaborator>(
                             sortColumns,
                             new List<Tuple<string, string>>
                             {
                                 //new Tuple<string, string>("HoldingBaseDto.Name", "Holding.Name")
                             },
                             new List<string> { "Collaborator.FirstName" },
        ...
        /// <param name="languageId">The language identifier.</param>
        /// <returns></returns>
        public async Task<List<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto>> FindAllBaseDtoByActiveBuyerNegotiations(
            string keywords,
            List<Guid> selectedAttendeeCollaboratorsUids,
            int editionId,
            int languageId)
        {
            var query = this.GetBaseQuery()
        ...
        /// <param name="languageId">The language identifier.</param>
        /// <returns></returns>
        public async Task<IPagedList<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto>> FindAllByActiveSellerNegotiationsAndByDataTable(
            int page,
            int pageSize,
            string keywords,
            List<Tuple<string, string>> sortColumns,
        ...
        /// <param name="languageId">The language identifier.</param>
        /// <returns></returns>
        public async Task<List<MusicBusinessRoundNegotiationAttendeeCollaboratorBaseDto>> FindAllBaseDtoByActiveSellerNegotiations(
           string keywords,
           List<Guid> selectedAttendeeCollaboratorsUids,
           int editionId,
           int languageId)
