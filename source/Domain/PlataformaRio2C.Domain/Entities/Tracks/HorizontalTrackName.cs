...
// ***********************************************************************
// <copyright file="HorizontalTrackName.cs" company="Softo">
...
{
    /// <summary>HorizontalTrackName</summary>
    public class HorizontalTrackName : Entity
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="HorizontalTrackName"/> class.</summary>
        /// <param name="value">The value.</param>
        /// <param name="language">The language.</param>
        /// <param name="userId">The user identifier.</param>
        public HorizontalTrackName(string value, Language language, int userId)
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="HorizontalTrackName"/> class.</summary>
        protected HorizontalTrackName()
        {
        }

        /// <summary>Updates the specified horizontal track name.</summary>
        /// <param name="horizontalTrackName">Name of the horizontal track.</param>
        public void Update(HorizontalTrackName horizontalTrackName)
        {
            this.Value = horizontalTrackName.Value?.Trim();
            this.UpdateDate = DateTime.Now;
            this.UpdateUserId = horizontalTrackName.UpdateUserId;
        }
