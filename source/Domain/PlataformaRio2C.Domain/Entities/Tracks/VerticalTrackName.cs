...
// ***********************************************************************
// <copyright file="VerticalTrackName.cs" company="Softo">
...
{
    /// <summary>VerticalTrackName</summary>
    public class VerticalTrackName : Entity
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="VerticalTrackName"/> class.</summary>
        /// <param name="value">The value.</param>
        /// <param name="language">The language.</param>
        /// <param name="userId">The user identifier.</param>
        public VerticalTrackName(string value, Language language, int userId)
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="VerticalTrackName"/> class.</summary>
        protected VerticalTrackName()
        {
        }

        /// <summary>Updates the specified vertical track name.</summary>
        /// <param name="verticalTrackName">Name of the vertical track.</param>
        public void Update(VerticalTrackName verticalTrackName)
        {
            this.Value = verticalTrackName.Value?.Trim();
            this.UpdateDate = DateTime.Now;
            this.UpdateUserId = verticalTrackName.UpdateUserId;
        }
