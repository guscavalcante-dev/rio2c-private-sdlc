...
// ***********************************************************************
// <copyright file="PresentationFormatName.cs" company="Softo">
...
{
    /// <summary>PresentationFormatName</summary>
    public class PresentationFormatName : Entity
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="PresentationFormatName"/> class.</summary>
        /// <param name="value">The value.</param>
        /// <param name="language">The language.</param>
        /// <param name="userId">The user identifier.</param>
        public PresentationFormatName(string value, Language language, int userId)
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="PresentationFormatName"/> class.</summary>
        protected PresentationFormatName()
        {
        }

        /// <summary>Updates the specified presentation format name.</summary>
        /// <param name="presentationFormatName">Name of the presentation format.</param>
        public void Update(PresentationFormatName presentationFormatName)
        {
            this.Value = presentationFormatName.Value?.Trim();
            this.UpdateDate = DateTime.UtcNow;
            this.UpdateUserId = presentationFormatName.UpdateUserId;
        }
