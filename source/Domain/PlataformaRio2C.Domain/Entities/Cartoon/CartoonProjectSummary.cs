...
// ***********************************************************************
// <copyright file="CartoonProjectSummary.cs" company="Softo">
...
{
    /// <summary>CartoonProjectSummary</summary>
    public class CartoonProjectSummary : Entity
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CartoonProjectSummary"/> class.</summary>
        /// <param name="value">The value.</param>
        /// <param name="language">The language.</param>
        /// <param name="userId">The user identifier.</param>
        public CartoonProjectSummary(string value, Language language, int userId)
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="CartoonProjectSummary"/> class.</summary>
        protected CartoonProjectSummary()
        {
        }

        /// <summary>Updates the specified summary.</summary>
        /// <param name="summary">The summary.</param>
        public void Update(CartoonProjectSummary summary)
        {
