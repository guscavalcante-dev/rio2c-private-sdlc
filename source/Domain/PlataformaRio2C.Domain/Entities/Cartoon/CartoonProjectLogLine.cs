...
// ***********************************************************************
// <copyright file="CartoonProjectLogLine.cs" company="Softo">
...
{
    /// <summary>CartoonProjectLogLine</summary>
    public class CartoonProjectLogLine : Entity
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CartoonProjectLogLine"/> class.</summary>
        /// <param name="value">The value.</param>
        /// <param name="language">The language.</param>
        /// <param name="userId">The user identifier.</param>
        public CartoonProjectLogLine(string value, Language language, int userId)
        {
        ...
        /// <summary>Initializes a new instance of the <see cref="CartoonProjectLogLine"/> class.</summary>
        protected CartoonProjectLogLine()
        {
        }

        /// <summary>Updates the specified log line.</summary>
        /// <param name="logLine">The log line.</param>
        public void Update(CartoonProjectLogLine logLine)
        {
