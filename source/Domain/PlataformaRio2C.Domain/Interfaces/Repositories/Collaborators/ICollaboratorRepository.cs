...
namespace PlataformaRio2C.Domain.Interfaces
{
    ...
    public interface ICollaboratorRepository : IRepository<Collaborator>
    {
        ...
        Task<IPagedList<CollaboratorBaseDto>> FindAllByDataTable(int page, int pageSize, string keywords, List<Tuple<string, string>> sortColumns, Guid organizationTypeId, bool showAllEditions, bool showAllExecutives, bool showAllParticipants, int? editionId);
