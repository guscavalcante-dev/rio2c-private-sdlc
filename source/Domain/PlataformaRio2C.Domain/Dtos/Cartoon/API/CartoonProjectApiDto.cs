...
namespace PlataformaRio2C.Domain.Dtos
{
    ...
    public class CartoonProjectApiDto
    {
        ...
        public static string GenerateTestJson()
        {
            ...
            //i.VideoUrl = "https://www.youtube.com/watch?v=u5FGUIasTLM";
            ...
            //i.AttendeeCartoonProjectCompetitorApiDtos = new List<AttendeeCartoonProjectCompetitorApiDto>()
            //{
            //    new AttendeeCartoonProjectCompetitorApiDto()
            //    {
            //        Name = "Skynet"
            //    },
            //    new AttendeeCartoonProjectCompetitorApiDto()
            ...
            //i.AttendeeCartoonProjectFounderApiDtos = new List<AttendeeCartoonProjectFounderApiDto>()
            //{
            //    new AttendeeCartoonProjectFounderApiDto()
            //    {
            ...
            //i.CartoonProjectExperienceOptionApiDtos = new List<CartoonProjectExperienceOptionApiDto>()
            //{
            //    new CartoonProjectExperienceOptionApiDto() { Uid = new Guid("82167C1D-7CA6-447F-80C7-AE9188ADD436"), AdditionalInfo = "" },
            //    new CartoonProjectExperienceOptionApiDto() { Uid = new Guid("29B2CC2F-374D-4F2F-AC00-3513D02EC9C3"), AdditionalInfo = "" },
            //    new CartoonProjectExperienceOptionApiDto() { Uid = new Guid("2FD9F6BA-8852-4DD5-A402-DCD2C14923CB"), AdditionalInfo = "" },
            //    new CartoonProjectExperienceOptionApiDto() { Uid = new Guid("60079B3B-A5D9-4E59-A964-725339AFBE7F"), AdditionalInfo = "" },
            //    new CartoonProjectExperienceOptionApiDto() { Uid = new Guid("4F440536-BAB7-4E43-A3A4-F977ABAFBDA8"), AdditionalInfo = "" },
            //};

            //i.CartoonProjectTrackOptionApiDtos = new List<CartoonProjectTrackOptionApiDto>()
            //{
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("702A9B2E-DBCB-4BB0-8405-C5BD72EAF627"), AdditionalInfo = ""},
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("0B1BD552-AD36-4A4D-A55D-D7B07EB6E4E0"), AdditionalInfo = ""},
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("FB997A1A-CBF0-446B-82FF-FF7B5EAA21BF"), AdditionalInfo = ""},
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("1646A4D0-F43A-4633-9730-3F8893A627CE"), AdditionalInfo = ""},
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("A7EEDEF9-88B9-4EF4-A6EA-32EA5DB28598"), AdditionalInfo = ""},
            //    new CartoonProjectTrackOptionApiDto(){ Uid = new Guid("B05FDB02-F880-49D0-818D-65BA716EC0B8"), AdditionalInfo = ""},
            //};

            //i.CartoonProjectTechnologyOptionApiDtos = new List<CartoonProjectTechnologyOptionApiDto>()
            //{
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("0EE805CD-7E63-47DE-8034-C405DC5E1DA3"), AdditionalInfo = ""},
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("6932AC40-E16D-4858-B550-1B4CD2F9461D"), AdditionalInfo = ""},
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("516E3187-CE60-4541-9F46-AC41F29EA0EB"), AdditionalInfo = ""},
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("9B3EFFFC-B4F9-4E65-B679-69EEE581DCC2"), AdditionalInfo = ""},
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("3663D8A3-DF1D-4A41-A3EF-13CF2602FA9D"), AdditionalInfo = ""},
            //    new CartoonProjectTechnologyOptionApiDto() { Uid = new Guid("F5B4623D-F4F9-4440-B575-140C273C41D2"), AdditionalInfo = "Microsserviços & CloudPlatform"},
            //};

            //i.CartoonProjectObjectivesOptionApiDtos = new List<CartoonProjectObjectivesOptionApiDto>()
            //{
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("9ECEFE6D-EA9A-4DCE-88A0-5B720E02EAE0"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("0A0EA283-D9CB-4BCE-87B9-5582C57B6E42"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("0D2684E1-4A8A-4088-8547-6AC274EB1EE4"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("064371D0-864F-4B79-B709-221F73B0D35D"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("38A07682-8BD4-4EDE-8BE2-1593BAD8E0B7"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("5F872B5B-DA41-43E6-ABE7-CEF7E6BC0CE6"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("1A144DB0-DBF2-4ECC-A4C0-267CEA374FAA"), AdditionalInfo = ""},
            //    new CartoonProjectObjectivesOptionApiDto() { Uid = new Guid("5F62C762-01C0-4F55-A89D-D1E5690817F6"), AdditionalInfo = "Captação de contatos"},
            //};
