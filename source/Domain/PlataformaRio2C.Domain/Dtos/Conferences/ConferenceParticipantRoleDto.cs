...
namespace PlataformaRio2C.Domain.Dtos
{
    ...
    public class ConferenceParticipantRoleDto
    {
        ...
        public ConferenceParticipantRoleTitleDto GetConferenceParticipantRoleTitleDtoByLanguageCode(string languageCode)
        {
            ...
            return this.ConferenceParticipantRoleTitleDtos?.FirstOrDefault(cprtd => cprtd.LanguageDto.Code == languageCode) ??
                   this.ConferenceParticipantRoleTitleDtos?.FirstOrDefault(cprtd => cprtd.LanguageDto.Code == "pt-br");
        }
    }
}