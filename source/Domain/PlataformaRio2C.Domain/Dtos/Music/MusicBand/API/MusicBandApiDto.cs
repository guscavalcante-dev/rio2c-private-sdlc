...
namespace PlataformaRio2C.Domain.Dtos
{
    ...
    public class MusicBandApiDto
    {
        ...
        public bool IsValid()
        {
            ...
            if (this.MusicBandResponsibleApiDto != null)
            {
            ...
            {
                this.ValidationResult.Add(new ValidationError(string.Format(Messages.TheFieldIsRequired, GetJsonPropertyAttributeName(nameof(MusicBandResponsibleApiDto)))));
            }

            if (this.MusicBandDataApiDtos != null)
            {
                foreach (var musicBandDataApiDto in this.MusicBandDataApiDtos.Where(dto => !dto.IsValid())?.ToList())
                {
                    this.ValidationResult.Add(musicBandDataApiDto.ValidationResult);
                }
            }
            else
            {
                this.ValidationResult.Add(new ValidationError(string.Format(Messages.TheFieldIsRequired, GetJsonPropertyAttributeName(nameof(MusicBandDataApiDtos)))));
            }
