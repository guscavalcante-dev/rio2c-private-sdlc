...
// ***********************************************************************
// <copyright file="InterestGroupController.cs" company="Softo">
...
{
    /// <summary>InterestGroupController</summary>
    [Authorize(Roles = "Administrator")]
    public class InterestGroupController : BaseController
    {
        private readonly IInterestGroupAppService _appService;

        /// <summary>Initializes a new instance of the <see cref="InterestGroupController"/> class.</summary>
        /// <param name="commandBus">The command bus.</param>
        /// <param name="identityController">The identity controller.</param>
        /// <param name="appService">The application service.</param>
        public InterestGroupController(IMediator commandBus, IdentityAutenticationService identityController, IInterestGroupAppService appService)
        ...
        public ActionResult Create(InterestGroupAppViewModel viewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(InterestGroupAppViewModel viewModel)
        {
