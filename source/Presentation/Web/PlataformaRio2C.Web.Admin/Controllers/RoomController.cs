...
// ***********************************************************************
// <copyright file="RoomController.cs" company="Softo">
...
namespace PlataformaRio2C.Web.Admin.Controllers
{
    ...
    public class RoomController : BaseController
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="RoomController"/> class.</summary>
        /// <param name="commandBus">The command bus.</param>
        /// <param name="identityController">The identity controller.</param>
        /// <param name="appService">The application service.</param>
        public RoomController(IMediator commandBus, IdentityAutenticationService identityController, IRoomAppService appService)
