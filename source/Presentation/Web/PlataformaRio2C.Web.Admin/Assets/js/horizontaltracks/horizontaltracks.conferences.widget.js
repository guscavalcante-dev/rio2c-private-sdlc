...
var HorizontalTracksConferencesWidget = function () {

    var widgetElementId = '#HorizontalTrackConferencesWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/HorizontalTracks/ShowConferencesWidget'), jsonParameters, function (data) {
