...
var TracksMainInformationWidget = function () {

    var widgetElementId = '#TrackMainInformationWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Tracks/ShowMainInformationWidget'), jsonParameters, function (data) {
