...
var OrganizationsApiConfigurationWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Organizations/ShowApiConfigurationWidget'), jsonParameters, function (data) {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (OrganizationsApiConfigurationWidget) !== 'undefined') {
                    OrganizationsApiConfigurationWidget.init();
                }
            },
    ...
    var showUpdateModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Organizations/ShowUpdateApiConfigurationModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
