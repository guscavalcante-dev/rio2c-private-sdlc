...
var OrganizationsExecutivesWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Organizations/ShowExecutivesWidget'), jsonParameters, function (data) {
        ...
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (OrganizationExecutivesWidget) !== 'undefined') {
                    OrganizationsExecutivesWidget.init($(organizationTypeElementId).val());
                }
            },
    ...
    var showAssociateModal = function (organizationUid) {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Organizations/ShowAssociateExecutiveModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
    ...
    var executeDisassociate = function (collaboratorUid, organizationUid) {
        ...
        $.post(MyRio2cCommon.getUrlWithCultureAndEdition('/Organizations/DisassociateExecutive'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
