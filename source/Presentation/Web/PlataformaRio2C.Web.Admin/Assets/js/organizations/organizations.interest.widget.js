...
// ***********************************************************************
// <copyright file="organizations.interest.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var OrganizationsInterestWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Players/ShowInterestWidget'), jsonParameters, function (data) {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (OrganizationsInterestWidget) !== 'undefined') {
    ...
    var showUpdateModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Players/ShowUpdateInterestModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
