...
var ConferenceParticipantRolesDataTableWidget = function () {

    var widgetElementId = '#ConferenceParticipantRolesDataTableWidget';
    var tableElementId = '#conferenceParticipantRoles-list-table';
    var table;
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/ParticipantRoles/Search'),
                data: function (d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        html += '               <button class="dropdown-item" onclick="ConferenceParticipantRolesDataTableWidget.showDetails(\'' + full.Uid + '\', false);"><i class="la la-edit"></i> ' + labels.edit + '</button>';
                        html += '               <button class="dropdown-item" onclick="ConferenceParticipantRolesDelete.showModal(\'' + full.Uid + '\', false);"><i class="la la-remove"></i> ' + labels.remove + '</button>';
