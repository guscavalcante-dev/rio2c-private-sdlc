...
var VerticalTracksDataTableWidget = function () {

    var widgetElementId = '#VerticalTracksDataTableWidget';
    var tableElementId = '#verticaltracks-list-table';
    var table;
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/VerticalTracks/Search'),
                data: function (d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        html += '               <button class="dropdown-item" onclick="VerticalTracksDataTableWidget.showDetails(\'' + full.Uid + '\', false);"><i class="la la-edit"></i> ' + labels.edit + '</button>';
                        html += '               <button class="dropdown-item" onclick="VerticalTracksDelete.showModal(\'' + full.Uid + '\', false);"><i class="la la-remove"></i> ' + labels.remove + '</button>';
    ...
    var showDetails = function (collaboratorUid) {
        ...
        window.location.href = MyRio2cCommon.getUrlWithCultureAndEdition('/VerticalTracks/Details/' + collaboratorUid);
    };
