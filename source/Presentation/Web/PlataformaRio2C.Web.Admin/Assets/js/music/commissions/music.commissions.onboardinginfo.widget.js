...
// ***********************************************************************
// <copyright file="music.commissions.onboardinginfo.widget.js" company="Softo">
...
var CollaboratorsOnboardingInfoWidget = function () {
    ...
    var widgetElementId = '#MusicCommissionOnboardingInfoWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Commissions/ShowOnboardingInfoWidget'), jsonParameters, function (data) {
