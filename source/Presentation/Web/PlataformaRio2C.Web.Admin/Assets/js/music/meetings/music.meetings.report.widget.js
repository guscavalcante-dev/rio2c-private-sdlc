...
// ***********************************************************************
// <copyright file="Music.meetings.report.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var MusicMeetingsReportWidget = function () {

    var widgetElementId = '#MusicMeetingsReportWidget';
    ...
    var enableSearchEvents = function () {
	    $('#SearchBuyerOrganizationUid').not('.change-event-enabled').on('change', function () {
		    MusicMeetingsReportWidget.search();
	    });
    ...
    var enableSearchForm = function () {
        ...
        MyRio2cCommon.enableOrganizationSelect2({ inputIdOrClass: '#SearchBuyerOrganizationUid', url: '/Music/Players/FindAllByFilters', customFilter: 'HasProjectNegotiationScheduled', placeholder: translations.playerDropdownPlaceholder });
        MyRio2cCommon.enableOrganizationSelect2({ inputIdOrClass: '#SearchSellerOrganizationUid', url: '/Music/Producers/FindAllByFilters', customFilter: 'HasProjectNegotiationScheduled', placeholder: translations.producerDropdownPlaceholder });
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/ShowReportDataWidget'), jsonParameters, function (data) {
    ...
    var exportExcel = function () {
        ...
        location.href = MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/ExportReportToExcel') + '?' + jQuery.param(jsonParameters);
    }
