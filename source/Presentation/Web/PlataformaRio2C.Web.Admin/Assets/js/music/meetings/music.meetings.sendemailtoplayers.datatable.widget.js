...
var MusicMeetingsSendEmailToPlayersDataTableWidget = function () {

    var widgetElementId = '#MusicMeetingsSendEmailToPlayersDataTableWidget';
    var tableElementId = '#musicmeetingssendemailtoplayers-list-table';
    var table;
    ...
    var sendEmails = function (sendEmailParameters) {
        ...
        $.post(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/SendPlayersEmails'), sendEmailParameters, function (data) {
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/SendEmailToPlayersSearch'),
                data: function (d) {
