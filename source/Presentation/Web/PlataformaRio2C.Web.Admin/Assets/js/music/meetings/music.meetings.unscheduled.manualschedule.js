...
// ***********************************************************************
// <copyright file="Music.meetings.unscheduled.manualschedule.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var MusicMeetingsManualSchedule = function () {

    var modalId = '#ManualScheduleMusicMeetingModal';
    var formId = '#ManualScheduleMusicMeetingForm';
    ...
    var enableBuyerOrganizationChangeEvent = function () {
        ...
        element.not('.change-event-enabled').on('change', function () {
            //TODO: To be implemented in the future. MusicMeetingsLogisticsInfoWidget.init([this.value, sellerOrganizationUidElement.val()]);
        });
    ...
    var showModal = function (projectBuyerEvaluationUid) {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/ShowManualScheduleModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (MusicMeetingsUnscheduledWidget) !== 'undefined') {
                    MusicMeetingsUnscheduledWidget.init();
                }
