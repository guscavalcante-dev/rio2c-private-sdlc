...
var MusicPlayersDataTableWidget = function () {

    var widgetElementId = '#MusicPlayersDataTableWidget';
    var tableElementId = '#musicplayers-list-table';
    var table;
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Players/Search'),
                data: function (d) {
    ...
    var exportToExcel = function () {
        ...
        location.href = '/Music/Players/ExportToExcel?' + jQuery.param(jsonParameters);
