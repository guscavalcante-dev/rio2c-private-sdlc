...
var MusicPlayersExecutivesDataTableWidget = function () {
    ...
    var sendInvitationEmails = function () {
        ...
        $.post(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/PlayersExecutives/SendInvitationEmails'), jsonParameters, function (data) {
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/Music/PlayersExecutives/Search'),
                data: function (d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return html; ///todo: not implementad
                       // return ""; 
                    }
                }
            ],
    ...
    var exportPlayersExecutivesReportToExcel = function () {
        ...
        location.href = '/Music/PlayersExecutives/ExportPlayersExecutivesReportToExcel?' + jQuery.param(jsonParameters);
    };
