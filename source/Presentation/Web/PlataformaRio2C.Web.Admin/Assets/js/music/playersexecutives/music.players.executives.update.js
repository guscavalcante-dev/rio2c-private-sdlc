...
// ***********************************************************************
// <copyright file="music.players.executives.update.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var MusicPlayersExecutivesUpdate = function () {
    ...
    var showModal = function (collaboratorUid, isAddingToCurrentEdition) {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/PlayersExecutives/ShowUpdateModal'), jsonParameters, function (data) {
