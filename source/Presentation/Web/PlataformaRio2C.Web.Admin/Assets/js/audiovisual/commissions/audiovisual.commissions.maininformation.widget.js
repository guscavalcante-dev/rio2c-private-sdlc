...
// ***********************************************************************
// <copyright file="audiovisual.commissions.maininformation.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var AudiovisualCommissionsMainInformationWidget = function () {

    var widgetElementId = '#AudiovisualCommissionMainInformationWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Audiovisual/Commissions/ShowMainInformationWidget'), jsonParameters, function (data) {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (AudiovisualCommissionsMainInformationWidget) !== 'undefined') {
                    AudiovisualCommissionsMainInformationWidget.init();
                }
            },
    ...
    var showUpdateModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Audiovisual/Commissions/ShowUpdateMainInformationModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
