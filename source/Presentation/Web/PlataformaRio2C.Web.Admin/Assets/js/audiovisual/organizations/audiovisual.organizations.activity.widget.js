...
var AudiovisualOrganizationsActivityWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Audiovisual/Organizations/ShowActivityWidget'), jsonParameters, function (data) {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (AudiovisualOrganizationsActivityWidget) !== 'undefined') {
                    AudiovisualOrganizationsActivityWidget.init();
                }
            },
