...
// ***********************************************************************
// <copyright file="audiovisual.producers.executives.create.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var ProducersExecutivesCreate = function () {

    var modalId = '#CreateProducerExecutiveModal';
    var formId = '#CreateProducerExecutiveForm';
    ...
    var showModal = function (attendeeOrganizationUid) {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Audiovisual/ProducersExecutives/ShowCreateModal'), jsonParameters, function (data) {
