...
// ***********************************************************************
// <copyright file="audiovisual.producers.executives.update.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var ProducersExecutivesUpdate = function () {

    var modalId = '#UpdateProducerExecutiveModal';
    var formId = '#UpdateProducerExecutiveForm';
    ...
    var showModal = function (collaboratorUid, isAddingToCurrentEdition) {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Audiovisual/ProducersExecutives/ShowUpdateModal'), jsonParameters, function (data) {
