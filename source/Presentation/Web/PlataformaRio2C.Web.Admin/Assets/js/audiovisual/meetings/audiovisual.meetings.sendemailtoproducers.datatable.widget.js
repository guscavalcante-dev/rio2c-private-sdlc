            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var sortedSellerNegotiationBaseDtos = row.SellerNegotiationBaseDtos.sortBy('StartDate');
                        for (var item in sortedSellerNegotiationBaseDtos) {
                            if (sortedSellerNegotiationBaseDtos.hasOwnProperty(item)) {
                                var r = sortedSellerNegotiationBaseDtos[item];
                                html += '\
