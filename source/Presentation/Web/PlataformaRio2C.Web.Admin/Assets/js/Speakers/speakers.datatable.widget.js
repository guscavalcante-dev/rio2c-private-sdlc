...
var SpeakersDataTableWidget = function () {
    ...
    var showExportEventbriteCsvModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Speakers/ShowExportEventbriteCsvModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
    ...
    var exportEventbriteCsv = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Speakers/ExportEventbriteCsv'), eventbriteCsvExport, function (data) {
            MyRio2cCommon.handleAjaxReturn({
                data: data,
                // Success
                onSuccess: function () {
