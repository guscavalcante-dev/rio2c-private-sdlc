...
// ***********************************************************************
// <copyright file="innovation.players.datatable.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var InnovationPlayersDataTableWidget = function () {

    var widgetElementId = '#InnovationPlayersDataTableWidget';
    var tableElementId = '#innovationplayers-list-table';
    var table;
    ...
    var initiListTable = function () {
        ...
        table = tableElement.DataTable({
            ...
            ajax: {
                url: MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Players/Search'),
                data: function (d) {
    ...
    var showDetails = function (playerUid) {
        ...
        window.location.href = MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Players/Details/' + playerUid);
    };
    ...
    var exportToExcel = function () {
        ...
        location.href = '/Innovation/Players/ExportToExcel?' + jQuery.param(jsonParameters);
