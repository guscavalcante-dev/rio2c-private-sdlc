...
// ***********************************************************************
// <copyright file="innovation.commissions.onboardinginfo.widget.js" company="Softo">
...
var InnovationCommissionsOnboardingInfoWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Commissions/ShowOnboardingInfoWidget'), jsonParameters, function (data) {
