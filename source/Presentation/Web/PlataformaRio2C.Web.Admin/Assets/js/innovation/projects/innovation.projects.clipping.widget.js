...
// ***********************************************************************
// <copyright file="innovation.projects.clipping.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var InnovationProjectsClippingWidget = function () {

    var widgetElementId = '#ProjectClippingWidget';
    var widgetElement = $(widgetElementId);

    var updateModalId = '#UpdateClippingModal';
    var updateFormId = '#UpdateClippingForm';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Projects/ShowClippingWidget'), jsonParameters, function (data) {
