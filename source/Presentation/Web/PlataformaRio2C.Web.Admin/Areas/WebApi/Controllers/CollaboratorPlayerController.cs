...
//    [RoutePrefix("api/collaboratorsplayers")]
//    public class CollaboratorPlayerController : BaseApiController
//    {
//        private readonly ICollaboratorPlayerAppService _appService;

//        public CollaboratorPlayerController(ICollaboratorPlayerAppService appService)
//        {
...
//            IEnumerable<CollaboratorPlayerItemListAppViewModel> result = null;

//            try
//            {
//                var pi = typeof(CollaboratorPlayerItemListAppViewModel).GetProperty(orderBy);
