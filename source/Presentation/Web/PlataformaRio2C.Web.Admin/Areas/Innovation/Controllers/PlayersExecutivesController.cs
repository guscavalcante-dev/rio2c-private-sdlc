    ...
    public class PlayersExecutivesController : BaseController
    {
        ...
        public ActionResult Index(CollaboratorSearchViewModel searchViewModel)
        {
            ...
            ViewBag.Breadcrumb = new BreadcrumbHelper(Labels.Players, new List<BreadcrumbItemHelper> {
                ...
                new BreadcrumbItemHelper(Labels.Executives, Url.Action("Index", "PlayersExecutives", new { Area = "Innovation" }))
            });
        ...
        {
            var playerExecutiveInnovation = await this.collaboratorRepo.FindAllByDataTable(
            ...
            var response = DataTablesResponse.Create(request, playerExecutiveInnovation.TotalItemCount, playerExecutiveInnovation.TotalItemCount, playerExecutiveInnovation);
        ...
        public async Task<ActionResult> Details(Guid? id)
        {
            ...
            if (attendeeCollaboratorDto == null)
            {
                ...
                return RedirectToAction("Index", "PlayersExecutives", new { Area = "Innovation" });
            }
            ...
            ViewBag.Breadcrumb = new BreadcrumbHelper(Labels.PlayersExecutives, new List<BreadcrumbItemHelper> {
                ...
                new BreadcrumbItemHelper(Labels.Players, Url.Action("Index", "Players", new { Area = "Innovation" })),
                new BreadcrumbItemHelper(Labels.Executives, Url.Action("Index", "PlayersExecutives", new { Area = "Innovation" })),
                new BreadcrumbItemHelper(attendeeCollaboratorDto.Collaborator.GetFullName(), Url.Action("Details", "PlayersExecutives", new { Area = "Innovation", id }))
            });
