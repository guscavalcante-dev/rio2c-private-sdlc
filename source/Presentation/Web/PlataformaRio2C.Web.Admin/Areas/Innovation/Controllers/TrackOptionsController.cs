...
namespace PlataformaRio2C.Web.Admin.Areas.Innovation.Controllers
{
    ...
    public class TrackOptionsController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> Delete(DeleteInnovationOrganizationTrackOption cmd)
        {
            var result = new AppValidationResult();
            ...
            return Json(new { status = "success", message = string.Format(Messages.EntityActionSuccessfull, Labels.CreativeEconomyTheme, Labels.DeletedM) });
        }
