...
namespace PlataformaRio2C.Web.Site.Areas.Audiovisual.Controllers
{
    ...
    public class PitchingProjectsController : BaseController
    {
        ...
        public async Task<ActionResult> UpdateMainInformation(UpdatePitchingProjectMainInformation cmd)
        {
            ...
            try
            {
                ...
                cmd.UpdatePreSendProperties(
                    ...
                    ProjectType.AudiovisualPitching.Uid,
        ...
        public async Task<ActionResult> ShowInterestWidget(Guid? projectUid)
        {
            ...
            ViewBag.GroupedInterests = await this.interestRepo.FindAllByProjectTypeIdAndGroupedByInterestGroupAsync(ProjectType.AudiovisualPitching.Id);
            ViewBag.TargetAudiences = await this.targetAudienceRepo.FindAllByProjectTypeIdAsync(ProjectType.AudiovisualPitching.Id);
        ...
        public async Task<ActionResult> ShowUpdateInterestModal(Guid? projectUid)
        {
            ...
            try
            {
                ...
                cmd = new UpdateProjectInterests(
                    interestWidgetDto,
                    await this.interestRepo.FindAllDtosByProjectTypeIdAsync(ProjectType.AudiovisualPitching.Id),
                    await this.targetAudienceRepo.FindAllByProjectTypeIdAsync(ProjectType.AudiovisualPitching.Id));
            }
            catch (DomainException ex)
            {
                return Json(new { status = "error", message = ex.GetInnerMessage() }, JsonRequestBehavior.AllowGet);
        ...
        public async Task<ActionResult> CompanyInfo()
        {
            ...
            var cmd = new OnboardProducerOrganizationData(
                ...
                await this.activityRepo.FindAllByProjectTypeIdAsync(ProjectType.AudiovisualPitching.Id),
                await this.targetAudienceRepo.FindAllByProjectTypeIdAsync(ProjectType.AudiovisualPitching.Id),
                true,
                true,
                true,
                ProjectType.AudiovisualPitching.Id);
