...
var CreatorProjectsEvaluationListWidget = function () {

    var widgetElementId = '#CreatorProjectEvaluationListWidget';
    var widgetElement;
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Creator/Projects/ShowEvaluationListWidget'), jsonParameters, function (data) {
    ...
    var search = function () {
        $('#Page').val('1');
       CreatorProjectsEvaluationListWidget.init();
    };
    ...
    var enablePageSizeChangeEvent = function () {
        $('#PageSizeDropdown').not('.change-event-enabled').on('change', function () {
            ...
            CreatorProjectsEvaluationListWidget.search();
        });
    ...
    var refreshProject = function (projectUid) {
	    ...
	    var jsonParameters = new Object();
        jsonParameters.attendeeCreatorProjectUid = projectUid;

        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Creator/Projects/ShowEvaluationListItemWidget'), jsonParameters, function (data) {
		    MyRio2cCommon.handleAjaxReturn({
			    data: data,
			    // Success
			    onSuccess: function () {
