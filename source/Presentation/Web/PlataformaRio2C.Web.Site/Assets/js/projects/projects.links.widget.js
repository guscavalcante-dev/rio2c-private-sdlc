...
var ProjectsLinksWidget = function () {
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Projects/ShowLinksWidget'), jsonParameters, function (data) {
    ...
    var showUpdateModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Projects/ShowUpdateLinksModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
            data: data,
            // Success
            onSuccess: function () {
