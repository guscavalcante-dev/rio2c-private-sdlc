...
var InnovationProjectsEvaluationListWidget = function () {

    var widgetElementId = '#InnovationProjectEvaluationListWidget';
    var widgetElement;
    ...
    var enableShowPlugins = function () {
        ...
        MyRio2cCommon.enableSelect2({ inputIdOrClass: '#InnovationOrganizationTrackOptionUid', allowClear: true, placeholder: translations.selectFPlaceholder.replace('{0}', translations.track) + '...' });
    ...
    var show = function () {
        ...
        jsonParameters.innovationOrganizationTrackOptionUid = $('#InnovationOrganizationTrackOptionUid').val();
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Projects/ShowEvaluationListWidget'), jsonParameters, function (data) {
    ...
    var search = function () {
        $('#Page').val('1');
        InnovationProjectsEvaluationListWidget.init();
    };
    ...
    var enableSearchEvents = function () {
        ...
        $('#InnovationOrganizationTrackOptionUid').not('.change-event-enabled').on('change', function () {
            search();
        });
        $('#InnovationOrganizationTrackOptionUid').addClass('change-event-enabled');
    ...
    var enablePageSizeChangeEvent = function () {
        $('#PageSizeDropdown').not('.change-event-enabled').on('change', function () {
            ...
            InnovationProjectsEvaluationListWidget.search();
        });
    ...
    var refreshProject = function (projectUid) {
	    ...
	    var jsonParameters = new Object();
        jsonParameters.attendeeInnovationOrganizationUid = projectUid;

	    $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Innovation/Projects/ShowEvaluationListItemWidget'), jsonParameters, function (data) {
		    MyRio2cCommon.handleAjaxReturn({
			    data: data,
			    // Success
			    onSuccess: function () {
