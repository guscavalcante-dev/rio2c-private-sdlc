...
var MusicMeetingsVirtualMeetingWidget = function () {

    var widgetElementId = '#MusicMeetingsVirtualMeetingWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/ShowVirtualMeetingWidget'), jsonParameters, function (data) {
    ...
    var almostOverCountDown = function () {
        ...
        if (!MyRio2cCommon.isNullOrEmpty(meeting.meetingIsAlmostOverAudioFile)) {
            var music = new Audio(meeting.meetingIsAlmostOverAudioFile);
            music.play();
        }
    }
