...
// ***********************************************************************
// <copyright file="music.meetings.maininformation.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var MusicMeetingsMainInformationWidget = function () {

    var widgetElementId = '#MusicMeetingsMainInformationWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/ShowMainInformationWidget'), jsonParameters, function (data) {
    ...
    var exitRoom = function () {
        ...
        window.location.href = MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Meetings/Index/');
    }
