...
var MusicBusinessRoundProjectsMainInformationWidget = function () {

    var widgetElementId = '#MusicBusinessRoundProjectsMainInformationWidget';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/BusinessRoundProjects/ShowMainInformationWidget'), jsonParameters, function (data) {
    ...
    var enableAjaxForm = function () {
        MyRio2cCommon.enableAjaxForm({
            ...
            onSuccess: function (data) {
                ...
                if (typeof (MusicBusinessRoundProjectsMainInformationWidget) !== 'undefined') {
                    MusicBusinessRoundProjectsMainInformationWidget.init();
                }
            },
    ...
    var showUpdateModal = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/BusinessRoundProjects/ShowUpdateMainInformationModal'), jsonParameters, function (data) {
            MyRio2cCommon.handleAjaxReturn({
            data: data,
            // Success
            onSuccess: function () {
