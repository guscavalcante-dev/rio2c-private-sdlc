...
// ***********************************************************************
// <copyright file="music.projects.videoandmusic.widget.js" company="Softo">
//     Copyright (c) Softo. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

var MusicProjectsVideoAndMusicWidget = function () {

    var widgetElementId = '#ProjectVideoAndMusicWidget';
    var widgetElement = $(widgetElementId);

    var updateModalId = '#UpdateVideoAndMusicModal';
    var updateFormId = '#UpdateVideoAndMusicForm';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/PitchingProjects/ShowVideoAndMusicWidget'), jsonParameters, function (data) {
