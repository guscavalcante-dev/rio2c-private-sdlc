...
var MusicProjectsTeamMembersWidget = function () {
    ...
    var updateFormId = '#UpdateTeamMemmbersForm';
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Music/Projects/ShowTeamMembersWidget'), jsonParameters, function (data) {
