...
var CartoonProjectsEvaluationListWidget = function () {

    var widgetElementId = '#CartoonProjectEvaluationListWidget';
    var widgetElement;
    ...
    var show = function () {
        ...
        $.get(MyRio2cCommon.getUrlWithCultureAndEdition('/Cartoon/Projects/ShowEvaluationListWidget'), jsonParameters, function (data) {
    ...
    var enablePageSizeChangeEvent = function () {
        $('#PageSizeDropdown').not('.change-event-enabled').on('change', function () {
            ...
            CartoonProjectsEvaluationListWidget.search();
        });
