...
// ***********************************************************************
// <copyright file="TrackSearchViewModel.cs" company="Softo">
...
{
    /// <summary>TrackSearchViewModel</summary>
    public class TrackSearchViewModel
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="TrackSearchViewModel"/> class.</summary>
