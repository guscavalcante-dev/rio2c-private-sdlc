...
namespace PlataformaRio2C.Application.CQRS.CommandsHandlers
{
    ...
    public class CreateTicketBuyerOrganizationDataCommandHandler : BaseOrganizationCommandHandler, IRequestHandler<CreateTicketBuyerOrganizationData, AppValidationResult>
    {
        ...
        public async Task<AppValidationResult> Handle(CreateTicketBuyerOrganizationData cmd, CancellationToken cancellationToken)
        {
            ...
            var attendeeCollaborator = await this.attendeeCollaboratorRepo.GetAsync(ac => ac.Collaborator.Uid == cmd.CollaboratorUid && ac.EditionId == cmd.EditionId);
            ...
            else
            {
                ...
                {
                    this.ValidationResult.Add(new ValidationError(string.Format(Messages.EntityExistsWithSameProperty, Labels.Company, Labels.TheName, cmd.CompanyName), new string[] { "TradeName" }));
                }
