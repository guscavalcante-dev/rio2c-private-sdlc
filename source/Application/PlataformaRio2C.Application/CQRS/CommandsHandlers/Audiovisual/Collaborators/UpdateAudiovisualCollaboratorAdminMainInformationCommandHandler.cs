...
// ***********************************************************************
// <copyright file="UpdateAudiovisualCollaboratorAdminMainInformationCommandHandler.cs" company="Softo">
...
{
    /// <summary>UpdateAudiovisualCollaboratorAdminMainInformationCommandHandler</summary>
    public class UpdateAudiovisualCollaboratorAdminMainInformationCommandHandler : BaseCollaboratorCommandHandler, IRequestHandler<UpdateAudiovisualCollaboratorAdminMainInformation, AppValidationResult>
    {
        ...
        public UpdateAudiovisualCollaboratorAdminMainInformationCommandHandler(
            IMediator eventBus,
            IUnitOfWork uow,
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(UpdateAudiovisualCollaboratorAdminMainInformation cmd, CancellationToken cancellationToken)
        {
