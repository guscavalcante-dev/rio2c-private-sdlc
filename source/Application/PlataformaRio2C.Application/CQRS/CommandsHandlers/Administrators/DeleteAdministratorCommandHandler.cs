...
{
    /// <summary>DeleteAdministratorCommandHandler</summary>
    public class DeleteAdministratorCommandHandler : BaseAdministratorCommandHandler, IRequestHandler<DeleteAdministrator, AppValidationResult>
    {
        private readonly IEditionRepository editionRepo;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAdministratorCommandHandler"/> class.
        /// </summary>
        /// <param name="eventBus">The event bus.</param>
        /// <param name="uow">The uow.</param>
        /// <param name="collaboratorRepository">The collaborator repository.</param>
        /// <param name="editionRepository">The edition repository.</param>
        public DeleteAdministratorCommandHandler(
            IMediator eventBus,
            IUnitOfWork uow,
        ...
        /// <summary>
        /// Handles the specified delete administrator.
        /// </summary>
        /// <param name="cmd">The command.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(DeleteAdministrator cmd, CancellationToken cancellationToken)
        {
