...
namespace PlataformaRio2C.Application.CQRS.CommandsHandlers
{
    ...
    /// </summary>
    public class SendPlayerNegotiationsEmailAsyncCommandHandler : MailerBaseCommandHandler, IRequestHandler<SendPlayerNegotiationsEmailAsync, AppValidationResult>
    {
        ...
        public SendPlayerNegotiationsEmailAsyncCommandHandler(
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(SendPlayerNegotiationsEmailAsync cmd, CancellationToken cancellationToken)
        {
