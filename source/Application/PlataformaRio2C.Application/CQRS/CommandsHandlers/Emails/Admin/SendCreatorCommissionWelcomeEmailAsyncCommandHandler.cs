...
// ***********************************************************************
// <copyright file="SendCreatorCommissionWelcomeEmailAsyncCommandHandler.cs" company="Softo">
...
{
    /// <summary>SendCreatorCommissionWelcomeEmailAsyncCommandHandler</summary>
    public class SendCreatorCommissionWelcomeEmailAsyncCommandHandler : MailerBaseCommandHandler, IRequestHandler<SendCreatorCommissionWelcomeEmailAsync, AppValidationResult>
    {
        private readonly ICollaboratorRepository collaboratorRepo;

        /// <summary>Initializes a new instance of the <see cref="SendCreatorCommissionWelcomeEmailAsyncCommandHandler"/> class.</summary>
        ...
        public SendCreatorCommissionWelcomeEmailAsyncCommandHandler(
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(SendCreatorCommissionWelcomeEmailAsync cmd, CancellationToken cancellationToken)
        {
            this.Uow.BeginTransaction();

            // Save sent email
            var sentEmailUid = Guid.NewGuid();
            var sentEmail = new SentEmail(sentEmailUid, cmd.RecipientUserId, cmd.Edition.Id, "CreatorCommissionWelcome");
            ...
            if (collaborator == null || collaborator.IsDeleted 
                || !collaborator.AttendeeCollaborators.Any(ac => !ac.IsDeleted
                                                                 ...
                                                                 && ac.AttendeeCollaboratorTypes.Any(act => !act.IsDeleted
                                                                                                            ...
                                                                                                            && act.CollaboratorType.Uid == CollaboratorType.ComissionCreator.Uid)))
            {
            ...
            // Sends the email
            await this.MailerService.SendCreatorCommissionWelcomeEmail(cmd, sentEmail.Uid).SendAsync();
