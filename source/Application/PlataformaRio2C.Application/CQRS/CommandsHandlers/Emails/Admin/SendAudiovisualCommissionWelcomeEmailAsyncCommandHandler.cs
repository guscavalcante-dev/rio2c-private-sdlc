...
// ***********************************************************************
// <copyright file="SendAudiovisualCommissionWelcomeEmailAsyncCommandHandler.cs" company="Softo">
...
{
    /// <summary>SendAudiovisualCommissionWelcomeEmailAsyncCommandHandler</summary>
    public class SendAudiovisualCommissionWelcomeEmailAsyncCommandHandler : MailerBaseCommandHandler, IRequestHandler<SendAudiovisualCommissionWelcomeEmailAsync, AppValidationResult>
    {
        private readonly ICollaboratorRepository collaboratorRepo;

        /// <summary>Initializes a new instance of the <see cref="SendAudiovisualCommissionWelcomeEmailAsyncCommandHandler"/> class.</summary>
        ...
        public SendAudiovisualCommissionWelcomeEmailAsyncCommandHandler(
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(SendAudiovisualCommissionWelcomeEmailAsync cmd, CancellationToken cancellationToken)
        {
            this.Uow.BeginTransaction();

            // Save sent email
            var sentEmailUid = Guid.NewGuid();
            var sentEmail = new SentEmail(sentEmailUid, cmd.RecipientUserId, cmd.Edition.Id, "AudiovisualCommissionWelcome");
            ...
            if (collaborator == null || collaborator.IsDeleted 
                || !collaborator.AttendeeCollaborators.Any(ac => !ac.IsDeleted
                                                                 ...
                                                                 && ac.AttendeeCollaboratorTypes.Any(act => !act.IsDeleted
                                                                                                            ...
                                                                                                            && act.CollaboratorType.Uid == CollaboratorType.ComissionAudiovisual.Uid)))
            {
            ...
            // Sends the email
            await this.MailerService.SendAudiovisualCommissionWelcomeEmail(cmd, sentEmail.Uid).SendAsync();
