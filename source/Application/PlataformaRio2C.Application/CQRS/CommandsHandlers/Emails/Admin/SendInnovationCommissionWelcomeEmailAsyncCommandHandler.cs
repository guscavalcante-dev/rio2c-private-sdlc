...
// ***********************************************************************
// <copyright file="SendInnovationCommissionWelcomeEmailAsyncCommandHandler.cs" company="Softo">
...
{
    /// <summary>SendInnovationCommissionWelcomeEmailAsyncCommandHandler</summary>
    public class SendInnovationCommissionWelcomeEmailAsyncCommandHandler : MailerBaseCommandHandler, IRequestHandler<SendInnovationCommissionWelcomeEmailAsync, AppValidationResult>
    {
        private readonly ICollaboratorRepository collaboratorRepo;

        /// <summary>Initializes a new instance of the <see cref="SendInnovationCommissionWelcomeEmailAsyncCommandHandler"/> class.</summary>
        ...
        public SendInnovationCommissionWelcomeEmailAsyncCommandHandler(
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(SendInnovationCommissionWelcomeEmailAsync cmd, CancellationToken cancellationToken)
        {
            this.Uow.BeginTransaction();

            // Save sent email
            var sentEmailUid = Guid.NewGuid();
            var sentEmail = new SentEmail(sentEmailUid, cmd.RecipientUserId, cmd.Edition.Id, "InnovationCommissionWelcome");
            ...
            if (collaborator == null || collaborator.IsDeleted 
                || !collaborator.AttendeeCollaborators.Any(ac => !ac.IsDeleted
                                                                 ...
                                                                 && ac.AttendeeCollaboratorTypes.Any(act => !act.IsDeleted
                                                                                                            ...
                                                                                                            && act.CollaboratorType.Uid == CollaboratorType.ComissionInnovation.Uid)))
            {
            ...
            // Sends the email
            await this.MailerService.SendInnovationCommissionWelcomeEmail(cmd, sentEmail.Uid).SendAsync();
