...
{
    /// <summary>OnboardTicketBuyerOrganizationDataCommandHandler</summary>
    public class OnboardTicketBuyerOrganizationDataCommandHandler : BaseOrganizationCommandHandler, IRequestHandler<OnboardTicketBuyerOrganizationData, AppValidationResult>
    {
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(OnboardTicketBuyerOrganizationData cmd, CancellationToken cancellationToken)
        {
