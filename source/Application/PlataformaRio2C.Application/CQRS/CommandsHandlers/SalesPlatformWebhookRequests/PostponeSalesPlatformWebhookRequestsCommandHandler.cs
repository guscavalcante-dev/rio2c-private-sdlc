...
// ***********************************************************************
// <copyright file="PostponeSalesPlatformWebhookRequestsCommandHandler.cs" company="Softo">
...
{
    /// <summary>PostponeSalesPlatformWebhookRequestsCommandHandler</summary>
    public class PostponeSalesPlatformWebhookRequestsCommandHandler : IRequestHandler<PostponeSalesPlatformWebhookRequest, Guid>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="PostponeSalesPlatformWebhookRequestsCommandHandler"/> class.</summary>
        /// <param name="eventBus">The event bus.</param>
        /// <param name="uow">The uow.</param>
        /// <param name="salesPlatformWebhookRequestRepository">The sales platform webhook request repository.</param>
        public PostponeSalesPlatformWebhookRequestsCommandHandler(
            IMediator eventBus,
            IUnitOfWork uow,
        ...
        /// <returns></returns>
        public async Task<Guid> Handle(PostponeSalesPlatformWebhookRequest cmd, CancellationToken cancellationToken)
        {
            ...
            salesPlatformWebhooRequest.Postpone(cmd.ErrorCode, cmd.ErrorMessage, cmd.SecurityStamp);
