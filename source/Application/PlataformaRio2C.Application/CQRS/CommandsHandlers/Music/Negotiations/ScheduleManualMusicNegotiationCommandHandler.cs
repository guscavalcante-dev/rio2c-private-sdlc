...
namespace PlataformaRio2C.Application.CQRS.CommandsHandlers
{
    ...
    public class ScheduleManualMusicNegotiationCommandHandler : BaseCommandHandler, IRequestHandler<ScheduleManualMusicBusinessNegotiation, AppValidationResult>
    {
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(ScheduleManualMusicBusinessNegotiation cmd, CancellationToken cancellationToken)
        {
