...
namespace PlataformaRio2C.Application.CQRS.CommandsHandlers
{
    ...
    public class UpdateMusicNegotiationCommandHandler : BaseCommandHandler, IRequestHandler<UpdateMusicBusinessRoundNegotiation, AppValidationResult>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMusicNegotiationCommandHandler"/> class.
        /// </summary>
        ...
        /// <param name="musicbusinessroundnegotiationRepository">The negotiation room configuration repository.</param>
        /// <param name="negotiationRoomConfigRepository">The negotiation room configuration repository.</param>
        /// <param name="attendeeCollaboratorRepository">The attendee collaborator repository.</param>
        public UpdateMusicNegotiationCommandHandler(
            IMediator eventBus,
            IUnitOfWork uow,
        ...
        public AppValidationResult AppValidationResult { get; private set; }
        ...
        public async Task<AppValidationResult> Handle(UpdateMusicBusinessRoundNegotiation cmd, CancellationToken cancellationToken)
        {
            ...
            var negotiation = await musicbusinessroundnegotiationRepo.FindByUidAsync(cmd.MusicRoundNegotiationUid);
            negotiation.Update(
                negotiationConfig,
