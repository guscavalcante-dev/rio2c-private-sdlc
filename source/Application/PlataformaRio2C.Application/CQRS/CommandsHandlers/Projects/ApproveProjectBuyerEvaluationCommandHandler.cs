...
// ***********************************************************************
// <copyright file="ApproveProjectBuyerEvaluationCommandHandler.cs" company="Softo">
...
{
    /// <summary>ApproveProjectBuyerEvaluationCommandHandler</summary>
    public class ApproveProjectBuyerEvaluationCommandHandler : BaseProjectCommandHandler, IRequestHandler<ApproveProjectBuyerEvaluation, AppValidationResult>
    {
        private IProjectBuyerEvaluationRepository ProjectBuyerEvaluationRepository;

        /// <summary>Initializes a new instance of the <see cref="ApproveProjectBuyerEvaluationCommandHandler"/> class.</summary>
        ...
        public ApproveProjectBuyerEvaluationCommandHandler(
            IMediator eventBus,
            IUnitOfWork uow,
        ...
        /// <returns></returns>
        public async Task<AppValidationResult> Handle(ApproveProjectBuyerEvaluation cmd, CancellationToken cancellationToken)
        {
            ...
            projectBuyer.Approve(cmd.ProjectBuyerEvaluationData);
