...
// ***********************************************************************
// <copyright file="SendAudiovisualCommissionWelcomeEmailAsync.cs" company="Softo">
...
{
    /// <summary>SendAudiovisualCommissionWelcomeEmailAsync</summary>
    public class SendAudiovisualCommissionWelcomeEmailAsync : EmailBaseCommand
    {
        public Guid Collaboratoruid { get; private set; }
        public string UserSecurityToken { get; private set; }
        public int UserId { get; private set; }

        /// <summary>Initializes a new instance of the <see cref="SendAudiovisualCommissionWelcomeEmailAsync"/> class.</summary>
        ...
        public SendAudiovisualCommissionWelcomeEmailAsync(
