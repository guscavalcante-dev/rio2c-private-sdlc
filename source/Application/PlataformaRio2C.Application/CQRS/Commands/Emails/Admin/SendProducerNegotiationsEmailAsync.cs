...
namespace PlataformaRio2C.Application.CQRS.Commands
{
    ...
    {
        public SellerAttendeeOrganizationBaseDto SellerAttendeeOrganizationBaseDto { get; private set; }
        public int UserId { get; private set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SendProducerNegotiationsEmailAsync"/> class.
        /// </summary>
        /// <param name="sellerAttendeeOrganizationBaseDto">The seller attendee organization base dto.</param>
        ...
        public SendProducerNegotiationsEmailAsync(
            SellerAttendeeOrganizationBaseDto sellerAttendeeOrganizationBaseDto,
            int recipientUserId, 
        ...
        {
            this.SellerAttendeeOrganizationBaseDto = sellerAttendeeOrganizationBaseDto;
            this.UserId = userId;
        }
