...
namespace PlataformaRio2C.Application.CQRS.Commands
{
    ...
    public class CreateCollaboratorTicket : BaseCommand
    {
        ...
        public CreateCollaboratorTicket(SalesPlatformAttendeeDto salesPlatformAttendeeDto, Edition edition, AttendeeSalesPlatformTicketType attendeeSalesPlatformTicketType)
        {
