...
// ***********************************************************************
// <copyright file="UpdateInnovationOrganization.cs" company="Softo">
...
{
    /// <summary>UpdateInnovationOrganization</summary>
    public class UpdateInnovationOrganization : BaseCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInnovationOrganization"/> class.
        /// </summary>
        /// <param name="innovationOrganizationApiDto">The innovation organization API dto.</param>
        public UpdateInnovationOrganization(InnovationOrganizationApiDto innovationOrganizationApiDto)
        {
        ...
        public UpdateInnovationOrganization(
            string name,
            string document,
            string serviceName,
