...
{
    public class MusicPlayerExecutiveCollaboratorBaseCommand : CollaboratorBaseCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MusicPlayerExecutiveCollaboratorBaseCommand" /> class.
        /// </summary>
        public MusicPlayerExecutiveCollaboratorBaseCommand()
        {
        }
        ...
        /// <param name="isAttendeeOrganizationRequired">if set to <c>true</c> [is isAttendeeOrganizationRequired required].</param>
