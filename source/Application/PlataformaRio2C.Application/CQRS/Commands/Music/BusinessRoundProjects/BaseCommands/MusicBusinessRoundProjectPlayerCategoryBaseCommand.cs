...
{
    public class MusicBusinessRoundProjectPlayerCategoryBaseCommand : BaseCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MusicBusinessRoundProjectPlayerCategoryBaseCommand"/> class.
        /// </summary>
        /// <param name="entity">The entity.</param>
        public MusicBusinessRoundProjectPlayerCategoryBaseCommand(MusicBusinessRoundProjectPlayerCategory entity)
        {
            this.MusicBusinessRoundProjectId = entity.MusicBusinessRoundProjectId;
            this.PlayerCategoryId = entity.PlayerCategoryId;
        ...
        /// Initializes a new instance of the <see cref="MusicBusinessRoundProjectPlayerCategoryBaseCommand"/> class.
        /// </summary>
        public MusicBusinessRoundProjectPlayerCategoryBaseCommand()
        {
        }
    }
