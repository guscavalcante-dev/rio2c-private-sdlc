...
namespace PlataformaRio2C.Application.CQRS.QueriesHandlers
{
    ...
    public class FindAllCollaboratorGenderAsyncQueryHandler : IRequestHandler<FindAllCollaboratorGenderAsync, List<CollaboratorGender>>
    {
        private readonly ICollaboratorGenderRepository repo;

        /// <summary>Initializes a new instance of the <see cref="FindAllLanguagesDtosAsyncQueryHandler"/> class.</summary>
        /// <param name="languageRepository">The language repository.</param>
        public FindAllCollaboratorGenderAsyncQueryHandler(ICollaboratorGenderRepository repository)
        {
        ...
        /// <returns></returns>
        public async Task<List<CollaboratorGender>> Handle(FindAllCollaboratorGenderAsync cmd, CancellationToken cancellationToken)
        {
